...
public class White_ship : MonoBehaviour {
	...
	void Start () {
        if (name.IndexOf("_") != -1) {
            tag = "White_ship";
            pirate1 = GameObject.Find("White_pirate1").transform;
            pirate2 = GameObject.Find("White_pirate2").transform;
            pirate3 = GameObject.Find("White_pirate3").transform;
